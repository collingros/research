...
parser.add_argument("-z", help="include people with beards", type=str)
...
for dir_name in dir_train:
    if (dir_name == "abdul" or dir_name == "brett") and BEARDS == 0:
        continue
    label = dir_c
    p[dir_name] = dir_c
        ...
        for pos_type in pos_type_names:
            ...
            for angle_type in angle_type_names:
                ...
                for img_name in img_names:
                    ...
                    #print("height: " + str(HEIGHT) +"\tratio: " + str(RATIO))
                    #cv2.imshow('img', img)
                    #cv2.waitKey(1)
