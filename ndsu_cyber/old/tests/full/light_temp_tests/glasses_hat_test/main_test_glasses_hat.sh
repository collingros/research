...
do
    ...
    python3 new_faces_train.py -$temp 1 -l $RES -a 1 -p 1 -t 1 -q 2 -f 1 -e 1 -s $TRSF -n $TRMN #w c l m h
    run_test
done

echo "training on w+c"
python3 new_faces_train.py -w 1 -c 1 -l $RES -a 1 -p 1 -t 1 -q 2 -f 1 -e 1 # w + c
run_test
echo "training on l+m+h"
python3 new_faces_train.py -d 1 -m 1 -b 1 -l $RES -a 1 -p 1 -t 1 -q 2 -f 1 -e 1 -s $TRSF -n $TRMN # l + m + h
run_test
