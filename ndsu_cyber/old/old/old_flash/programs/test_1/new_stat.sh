...
run_test ()
{
    for x in "collin_gros" "demitrius"
    do
...
# hat only
python3 c_faces_train2.py -e 0 -f 1 -v 0 -d 1 -m 1 -b 1 -q 2 -p 0 -a 1 -t 1
echo "phase 7 training finished"
run_test
echo "phase 7 finished"
# glasses only
python3 c_faces_train2.py -e 1 -f 0 -v 0 -d 1 -m 1 -b 1 -q 2 -p 0 -a 1 -t 1
echo "phase 8 training finished"
run_test
echo "phase 8 finished"
# all hat, glasses, face
python3 c_faces_train2.py -e 1 -f 1 -v 1 -d 1 -m 1 -b 1 -q 2 -p 0 -a 1 -t 1
echo "phase 9 training finished"
run_test
echo "phase 9 finished"
# with profiles
python3 c_faces_train2.py -e 1 -f 1 -v 1 -d 1 -m 1 -b 1 -q 2 -p 1 -a 1 -t 1
