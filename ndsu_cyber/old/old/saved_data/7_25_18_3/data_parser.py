...
key: 10	value: HEIGHT (int)
key: 11	value: RATIO (float)
key: 12	value: GLASSES (int)
key: 13	value: HAT (int)
key: 14	value: VANILLA (int)
key: 15	value: WARM (int)
key: 16	value: COLD (int)
key: 17	value: LOW (int)
key: 18	value: MED (int)
key: 19	value: HIGH (int)
key: 20	value: SHADOWS (int)
key: 21	value: PROFILES (int)
key: 22	value: ANGLED (int)
key: 23	value: CENTER (int)
key: 24	value: -1 NEW TEST
'''
