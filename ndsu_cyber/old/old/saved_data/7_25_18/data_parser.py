...
for test in tests:
    ...
    if x % TESTS_NUM == TESTS_NUM - 1:
        print("avg r cold: " + str(round((rec_c / 5), 2)) + "\tavg d cold: " + str(round((dec_c / 5), 2))
        print("avg r warm: " + str(round((rec_w / 5), 2)) + "\tavg d warm: " + str(round((dec_w / 5), 2))
        print("avg r low: " + str(round((rec_l / 5), 2)) + "\tavg d low: " + str(round(dec_l / 5), 2))
        print("avg r med: " + str(round((rec_m / 5), 2)) + "\tavg d med: " + str(round((dec_m / 5), 2))
        print("avg r high: " + str(round((rec_h / 5), 2)) + "\tavg d high: " + str(round((dec_h / 5), 2))
        c += TESTS_NUM
        phase += 1
    if x + 1 == test_len:
